...
name: implementer
description: |
  Use this agent when executing a single implementation task from a plan and you need code changes, tests, branch-note updates, and a local review checkpoint on wip/*. Examples: <example>Context: A plan task is ready to be implemented. user: "Implement Task 3 from the plan" assistant: "I'll use the implementer agent for the task implementation" <commentary>The task needs concrete implementation work with tests and a local checkpoint.</commentary></example>
model: inherit
---
